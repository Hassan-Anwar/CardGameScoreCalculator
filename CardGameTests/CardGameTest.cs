...
namespace CardGameScoreCalculator.Tests
{
    ...
    public class CardGameTests
    {
        ...
        [Fact]
        public void CalculateScore_ShouldReturnCorrectScore_ForSingleCard()
        {
            var game = new CardGame("8D");
            int score = game.CalculateScore();
        ...
        [Fact]
        public void CalculateScore_ShouldThrowException_WhenJokerAndInvalidCardPresent()
        {
            Assert.Throws<ArgumentException>(() => new CardGame("JK,1S"));
        }
